...
public class FarmObjectFactoryImpl implements FarmObjectFactory {
    ...
    private static final List supportedAnimalTypes = Arrays.asList(Cat.ANIMAL_TYPE, Dog.ANIMAL_TYPE, Cow.ANIMAL_TYPE, Duck.ANIMAL_TYPE, Fish.ANIMAL_TYPE);
